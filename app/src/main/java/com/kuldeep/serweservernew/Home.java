...
public class Home extends AppCompatActivity
    ...
    EditText edtName, edtDesc, edtPhone, edtEmail, edtTable, edtRating;
    Button btnUpload;
    Button btnSelect;
                            ...
                            imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    newCategory = new Category(edtName.getText().toString(),
                                            uri.toString(), edtDesc.getText().toString(), edtEmail.getText().toString(), edtPhone.getText().toString(),
                                            Long.parseLong(edtTable.getText().toString()));
                                }
                            });
                        }
                    })
